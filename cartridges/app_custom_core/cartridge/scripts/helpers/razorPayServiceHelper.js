 ...
 */
function razorPayCreateOrderRequest(req) {
    ...
    var amount = RazorPayUtils.getAmount(null, req);

    //data object for making service call
    var dataPost = {
        amount: amount.value.toFixed(2) * (preferences.razorpayPriceConversionFactor),//specific of Razorpay service convertion factor // amount: amount.value * 100, // test purpose
